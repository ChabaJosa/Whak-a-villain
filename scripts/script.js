...
let startRange      = 200;
let endRange        = 3000;
let heroePaths      = ["./images/heroes/cap2.png","./images/heroes/ironman.png","./images/heroes/drstrange.png"];
let villainPaths    = ["./images/villains/doom.png","./images/villains/thanos2.png","./images/villains/galactus.png"];
